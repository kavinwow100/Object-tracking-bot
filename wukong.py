...
from robot import config, utils, constants, logging, Player, BCI
from personTracking import *
...
*          (c) 2021 gusong <478246723@qq.com>          *
*               http://10.1.143.17:5000/               *
********************************************************
...
'''.format(config.get('/server/host', '0.0.0.0'), config.get('/server/port', '5000')))
        ...
        self._conversation.say('{} 你好！我是大象，接下来我将扫描一周找找你哦'.format(config.get('first_name', '主人')))
        # 摄像头追踪模块
#         for i in range(2):
#             turn_around(self._conversation)
        daily_task(self._conversation)
